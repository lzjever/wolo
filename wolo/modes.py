...
class QuotaConfig:
    ...
    """
    max_steps: int = 100
    max_tokens: Optional[int] = None  # Future: token limit
    max_time_seconds: Optional[int] = None  # Future: time limit
    
    def check_quota_exceeded(self, current_steps: int, current_tokens: Optional[int] = None) -> bool:
        """
