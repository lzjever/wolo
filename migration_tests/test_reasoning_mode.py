...
async def test_reasoning_mode():
    ...
    try:
        ...
        if reasoning_events:
            print("✅ SUCCESS: GLM thinking mode → lexilux reasoning working!")
            ...
            print("⚠️  No reasoning events received")
            print("   This might be normal if:")
            print("   - The model doesn't support thinking for this query")
            print("   - The question wasn't complex enough to trigger reasoning")
            print("   - The API doesn't expose thinking content")
